...
class AA {
 public:
  ...
  std::string msg_;
  AA()=default;
  AA(int code, std::string msg): code_(code) {
   msg_ = msg;
  }
};
...
//  inst.b = "123";
//  printf("a: %d, b: %s\n", inst.a, inst.b);
//  inst.b = "Invalid conf path: failed to open conf=, err_c_str=Invalid conf path: failed to open conf=";
//  printf("a: %d, b: %s\n", inst.a, inst.b);
//  std::string s = "abcd";
